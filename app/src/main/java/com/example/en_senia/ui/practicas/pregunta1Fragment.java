...
public class pregunta1Fragment extends Fragment {
    ...
    private Pregunta1ViewModel mViewModel;

    public static pregunta1Fragment newInstance() {
        return new pregunta1Fragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(Pregunta1ViewModel.class);
