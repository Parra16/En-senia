package com.example.en_senia.ui.leccion;
...
public class LeccionFragment extends Fragment {
    ...
    private LeccionViewModel mViewModel;

    public static LeccionFragment newInstance() {
        return new LeccionFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(LeccionViewModel.class);
